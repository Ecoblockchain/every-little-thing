...
function checkForm() {
  $('.btn-next').click(function(){
    $(this).parents('.page').slideUp('');
     $(this).parents('.page').next().slideDown('');
  });

    $('.btn-prev').click(function(){
    $(this).parents('.page').slideUp('');
     $(this).parents('.page').prev().slideDown('');
  });
  ...
  //description
  $('#input-description').keyup(function(e) {
    if (e.keyCode == 13) {
      $("#page-5").slideUp('');
      $("#page-6").slideDown('');
    }
